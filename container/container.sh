...
# 오버레이 마운트
mkdir -p /$CGROUP_NAME/container
mkdir -p /$CGROUP_NAME/work
mkdir -p /$CGROUP_NAME/merge
mount -t overlay overlay \
-o lowerdir=/tmp/tools:/tmp/myroot,upperdir=/$CGROUP_NAME/container,workdir=/$CGROUP_NAME/work \
/$CGROUP_NAME/merge
